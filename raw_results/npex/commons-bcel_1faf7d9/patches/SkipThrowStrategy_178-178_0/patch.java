...
public MethodGen(final org.apache.bcel.classfile.Method m, final java.lang.String class_name, final org.apache.bcel.generic.ConstantPoolGen cp) {
    /* NPEX_PATCH_BEGINS */
    if (m.getCode() == null) {
        throw new org.apache.bcel.generic.ClassGenException();
    }
    /* may be overridden anyway */
    this(m.getAccessFlags(), org.apache.bcel.generic.Type.getReturnType(m.getSignature()), org.apache.bcel.generic.Type.getArgumentTypes(m.getSignature()), null, m.getName(), class_name, (m.getAccessFlags() & (org.apache.bcel.Const.ACC_ABSTRACT | org.apache.bcel.Const.ACC_NATIVE)) == 0 ? new org.apache.bcel.generic.InstructionList(m.getCode().getCode()) : null, cp);
